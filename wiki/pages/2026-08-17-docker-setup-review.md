...
**Fix:** Resolve the conflict (keep both references, with the canonical one being [[2026-08-10-docker-compose-deploy.md]] and the auto-generated `2026-08-10-mnt-164-docker-compose.md` relegated to "see also" or deleted if it's a stub).
