...
> **Consistency note (2026-08-23):** `test_major_version_epic` was removed by MNT-176
> ([[2026-08-21-mnt-176-bump-version-error]]); the current suite uses
> `test_major_version_preserved` instead (`tests/test_project.py:26`). The pytest output
> above is kept as the session record.
