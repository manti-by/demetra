...
> **Consistency note (2026-08-20):** on current `master`, the third `OPENCODE_REVIEW_MODELS` default entry is again `opencode-go/kimi-k2.7-code` (`demetra/settings.py:141-143`); `minimax-m3` remains the default **plan** model only.
