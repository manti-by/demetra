...
- [MNT-204: Research result modal](pages/2026-09-11-research-plan-artifact.md) — Implementation of MNT-204: Research result modal (2026-09-14)
...
- [MNT-188: Waitlist](pages/2026-08-28-mnt-188-waitlist.md) — The waitlist lets blocked users register interest; admins approve entries via CLI to add them to the allowlist. (2026-08-28)
...
- [Session History & Token Consumption Audit (Revalidated)](pages/2026-07-23-session-tokens-audit-revalidation.md) — Corrected audit: compaction is live and non-cumulative (`build.py:102`), NULL rows were pipe-truncation (fixed, zero since); cache-read exclusion from the compaction decision is still an open recommendation. (2026-07-23)
...
- [MNT-204: Research result modal](pages/2026-09-11-research-plan-artifact.md) — 2026-09-14
