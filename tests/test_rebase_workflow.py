...
def base_mocks():
    with (
        ...
        patch("demetra.workflows.rebase.get_user_environments_decrypted", new_callable=AsyncMock) as mock_get_user_env,
        patch("demetra.workflows.rebase.setup_project_venv", new_callable=AsyncMock) as mock_venv,
